namespace HDU_Website.Models
{
    ...
    public partial class EGOV_CongVanDi
    {
        ...
        public int? KL_IDTrangThaiXuLy { get; set; }

        public string KL_NoiDungDanhGia { get; set; }

        public DateTime? KL_NgayDanhGia { get; set; }

        public int? KL_NguoiDanhGia { get; set; }
    }
}
